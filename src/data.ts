...
import SaoPauloLogo from "./assets/teamsBR/SaoPaulo.png";
import InternacionalLogo from "./assets/teamsBR/Internacional.png";
import GremioLogo from "./assets/teamsBR/Gremio.png";
import CorinthiansLogo from "./assets/teamsBR/Corinthians.png";
import CruzeiroLogo from "./assets/teamsBR/Cruzeiro.png";
import FluminenseLogo from "./assets/teamsBR/Fluminense.png";
import BotafogoLogo from "./assets/teamsBR/Botafogo.png";
import RemoLogo from "./assets/teamsBR/Remo.png";
import AtleticoMineiroLogo from "./assets/teamsBR/AtleticoMineiro.png";
import BahiaLogo from "./assets/teamsBR/Bahia.png";
import FortalezaLogo from "./assets/teamsBR/Fortaleza.png";
import CearaLogo from "./assets/teamsBR/Ceara.png";
import VitoriaLogo from "./assets/teamsBR/Vitoria.png";
import JuventudeLogo from "./assets/teamsBR/Juventude.png";
import VascodaGamaLogo from "./assets/teamsBR/VascodaGama.png";
import SantosLogo from "./assets/teamsBR/Santos.png";
import GoiasLogo from "./assets/teamsBR/Goias.png";
...
export const TEAMS: Team[] = [
  ...
  { id: "br4", name: "At. Mineiro", level: 2, country: "BR", logo: AtleticoMineiroLogo },
  ...
  { id: "br11", name: "A. Paranaense", level: 3, country: "BR", logo: AthleticoParanaenseLogo },
  ...
  { id: "br36", name: "Operário", level: 1, country: "BR", division: 2, logo: OperarioLogo },
  { id: "br37", name: "Londrina", level: 1, country: "BR", division: 2, logo: LondrinaLogo },
  { id: "br38", name: "Botafogo-SP", level: 1, country: "BR", division: 2, logo: BotafogoSPLogo },
  { id: "br39", name: "Náutico", level: 1, country: "BR", division: 2, logo: NauticoLogo },
  { id: "br40", name: "São Bernardo", level: 1, country: "BR", division: 2, logo: SaoBernardoLogo },
  // INGLATERRA (EN) - Div 1
  ...
  { id: "en51", name: "C. Palace", level: 3, color: "#008000", country: "EN", logo: CrystalPalaceLogo },
  ...
  { id: "en55", name: "N. Forest", level: 3, color: "#800080", country: "EN", logo: NottinghamForestLogo },
  ...
  { id: "en58", name: "L. City", level: 2, color: "#0000FF", country: "EN", logo: LeicesterCityLogo },
 ...
 // ITÁLIA (IT) - Div 1
  ...
  { id: "it94", name: "Verona", level: 2, color: "#FFFF00", country: "IT", logo: VeronaLogo }, 
  ...
  { id: "de187", name: "G. Fürth", level: 1, color: "#800080", country: "DE", division: 2 },
  ...
  { id: "pt245", name: "V. de Guimarães", level: 3, color: "#000000", country: "PT" },
  ...
  { id: "pt255", name: "E. da Amadora", level: 1, color: "#800080", country: "PT", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Emblema_Estrela_da_Amadora.jpg/250px-Emblema_Estrela_da_Amadora.jpg" },
  ...
  // PORTUGAL (PT) - Div 2
  { id: "pt261", name: "P. de Ferreira", level: 1, color: "#FF0000", country: "PT", division: 2 },
  ...
  { id: "pt268", name: "A. de Viseu", level: 1, color: "#FFA500", country: "PT", division: 2 },
  ...
  { id: "nl287", name: "Sparta R.", level: 2, color: "#800080", country: "NL" },
  ...
  { id: "nl289", name: "Ahead Eagles", level: 2, color: "#FF0000", country: "NL", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Go_Ahead_Eagles_logo.svg/250px-Go_Ahead_Eagles_logo.svg.png" },
  ...
  { id: "nl293", name: "F. Sittard", level: 1, color: "#000000", country: "NL" },
  ...
  { id: "nl309", name: "H. Sport", level: 1, color: "#FF0000", country: "NL", division: 2 },
  ...
  { id: "nl320", name: "Jong Utrecht", level: 1, color: "#FFFFFF", country: "NL", division: 2 },
  ...
  { id: "us323", name: "Los Angeles", level: 2, color: "#008000", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Los_Angeles_Football_Club.svg/250px-Los_Angeles_Football_Club.svg.png" },
  { id: "us324", name: "NY City", level: 2, color: "#FFFFFF", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Logo_New_York_City_FC_2025.svg/250px-Logo_New_York_City_FC_2025.svg.png" },
  { id: "us325", name: "S. Sounders", level: 2, color: "#000000", country: "US" },
  { id: "us326", name: "A. United", level: 2, color: "#FFFF00", country: "US" },
  { id: "us327", name: "C. Crew", level: 1, color: "#800080", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Columbus_Crew_logo_2021.svg/250px-Columbus_Crew_logo_2021.svg.png" },
  { id: "us328", name: "Cincinnati", level: 1, color: "#FFA500", country: "US" },
  { id: "us329", name: "P. Union", level: 1, color: "#FF0000", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/4/46/Philadelphia_Union_2018_logo.svg/250px-Philadelphia_Union_2018_logo.svg.png" },
  { id: "us330", name: "Orlando City", level: 1, color: "#0000FF", country: "US" },
  { id: "us331", name: "Toronto", level: 1, color: "#008000", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/7/7c/Toronto_FC_Logo.svg/330px-Toronto_FC_Logo.svg.png" },
  { id: "us332", name: "NY Red Bulls", level: 1, color: "#FFFFFF", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/5/51/New_York_Red_Bulls_logo.svg/250px-New_York_Red_Bulls_logo.svg.png" },
  { id: "us333", name: "P. Timbers", level: 1, color: "#000000", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Portland_Timbers_logo.svg/250px-Portland_Timbers_logo.svg.png" },
  { id: "us334", name: "Sporting KC", level: 1, color: "#FFFF00", country: "US" },
  { id: "us335", name: "H. Dynamo", level: 1, color: "#800080", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Houston_Dynamo_FC_logo.svg/250px-Houston_Dynamo_FC_logo.svg.png" },
  { id: "us336", name: "Salt Lake", level: 1, color: "#FFA500", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/5/54/Real_Salt_Lake_2010.svg/250px-Real_Salt_Lake_2010.svg.png" },
  { id: "us337", name: "M. United", level: 1, color: "#FF0000", country: "US" },
  { id: "us338", name: "C. Rapids", level: 1, color: "#0000FF", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/Colorado_Rapids_logo.svg/250px-Colorado_Rapids_logo.svg.png" },
  { id: "us339", name: "Charlotte", level: 1, color: "#008000", country: "US", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/9/91/Charlotte_FC_logo.svg/250px-Charlotte_FC_logo.svg.png" },
  { id: "us340", name: "Louis City", level: 1, color: "#FFFFFF", country: "US", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Logo_of_St._Louis_City_SC.svg/250px-Logo_of_St._Louis_City_SC.svg.png" },
  // ESTADOS UNIDOS (US) - Div 2
  { id: "us341", name: "B. Rowdies", level: 1, color: "#FF0000", country: "US", division: 2 },
  { id: "us342", name: "P. Rising", level: 1, color: "#0000FF", country: "US", division: 2 },
  { id: "us343", name: "L. City", level: 1, color: "#008000", country: "US", division: 2 },
  { id: "us344", name: "S. Republic", level: 1, color: "#FFFFFF", country: "US", division: 2 },
  { id: "us345", name: "C. Battery", level: 1, color: "#000000", country: "US", division: 2 },
  { id: "us346", name: "Indy Eleven", level: 1, color: "#FFFF00", country: "US", division: 2 },
  { id: "us347", name: "San Antonio", level: 1, color: "#800080", country: "US", division: 2 },
  { id: "us348", name: "Orange County", level: 1, color: "#FFA500", country: "US", division: 2 },
  { id: "us349", name: "Switchbacks", level: 1, color: "#FF0000", country: "US", division: 2 },
  { id: "us350", name: "P. Riverhounds", level: 1, color: "#0000FF", country: "US", division: 2 },
  { id: "us351", name: "El Paso L.", level: 1, color: "#008000", country: "US", division: 2 },
  { id: "us352", name: "NM United", level: 1, color: "#FFFFFF", country: "US", division: 2 },
  { id: "us353", name: "Memphis 901", level: 1, color: "#000000", country: "US", division: 2 },
  { id: "us354", name: "Monterey Bay", level: 1, color: "#FFFF00", country: "US", division: 2 },
  { id: "us355", name: "L. United", level: 1, color: "#800080", country: "US", division: 2 },
  { id: "us356", name: "Tulsa", level: 1, color: "#FFA500", country: "US", division: 2 },
  { id: "us357", name: "R. Island", level: 1, color: "#FF0000", country: "US", division: 2 },
  { id: "us358", name: "Oakland Roots", level: 1, color: "#0000FF", country: "US", division: 2 },
  { id: "us359", name: "Miami", level: 1, color: "#008000", country: "US", division: 2 },
  { id: "us360", name: "Vegas Lights", level: 1, color: "#FFFFFF", country: "US", division: 2 },
  ...
  { id: "ar411", name: "A. Juniors", level: 2, color: "#008000", country: "AR", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Escudo_de_la_Asociaci%C3%B3n_Atl%C3%A9tica_Argentinos_Juniors.svg/250px-Escudo_de_la_Asociaci%C3%B3n_Atl%C3%A9tica_Argentinos_Juniors.svg.png" },
  { id: "ar412", name: "D. y Justicia", level: 2, color: "#FFFFFF", country: "AR" },
  ...
  { id: "ar417", name: "G. y Esgrima", level: 1, color: "#FF0000", country: "AR" },
  ...
  // ARGENTINA (AR) - Div 2
  { id: "ar421", name: "San Martín", level: 1, color: "#FF0000", country: "AR", division: 2 },
  { id: "ar422", name: "Quilmes", level: 1, color: "#0000FF", country: "AR", division: 2 },
  { id: "ar423", name: "F. Carril Oeste", level: 1, color: "#008000", country: "AR", division: 2 },
  { id: "ar424", name: "C. Juniors", level: 1, color: "#FFFFFF", country: "AR", division: 2 },
  { id: "ar425", name: "N. Chicago", level: 1, color: "#000000", country: "AR", division: 2 },
  { id: "ar426", name: "Aldosivi", level: 1, color: "#FFFF00", country: "AR", division: 2 },
  { id: "ar427", name: "San Martín", level: 1, color: "#800080", country: "AR", division: 2 },
  { id: "ar428", name: "Gimnasia", level: 1, color: "#FFA500", country: "AR", division: 2 },
  { id: "ar429", name: "Colón", level: 1, color: "#FF0000", country: "AR", division: 2 },
  { id: "ar430", name: "At. Rafaela", level: 1, color: "#0000FF", country: "AR", division: 2 },
  { id: "ar431", name: "All Boys", level: 1, color: "#008000", country: "AR", division: 2 },
  { id: "ar432", name: "D. Morón", level: 1, color: "#FFFFFF", country: "AR", division: 2 },
  { id: "ar433", name: "San Miguel", level: 1, color: "#000000", country: "AR", division: 2 },
  { id: "ar434", name: "D. de Belgrano", level: 1, color: "#FFFF00", country: "AR", division: 2 },
  { id: "ar435", name: "Estudiantes", level: 1, color: "#800080", country: "AR", division: 2 },
  { id: "ar436", name: "A. Brown", level: 1, color: "#FFA500", country: "AR", division: 2 },
  ...
  { id: "ar439", name: "D. Madryn", level: 1, color: "#008000", country: "AR", division: 2 },
  ...
  { id: "uy443", name: "D. Sporting", level: 1, color: "#008000", country: "UY", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Defensor_Sporting.svg/250px-Defensor_Sporting.svg.png" },
  ...
  { id: "uy449", name: "Racing(URU)", level: 1, color: "#FF0000", country: "UY" },
  { id: "uy450", name: "Progreso", level: 1, color: "#0000FF", country: "UY" },
  { id: "uy451", name: "Plaza Colonia", level: 1, color: "#008000", country: "UY" },
  { id: "uy452", name: "D. Maldonado", level: 1, color: "#FFFFFF", country: "UY", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Deportivo_Maldonado_2020.png/250px-Deportivo_Maldonado_2020.png" },
  { id: "uy453", name: "Cerro Largo", level: 1, color: "#000000", country: "UY" },
  { id: "uy454", name: "M. Misiones", level: 1, color: "#FFFF00", country: "UY", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Escudo_Miramar_Misiones.jpg/250px-Escudo_Miramar_Misiones.jpg" },
  { id: "uy455", name: "C. Español", level: 1, color: "#800080", country: "UY", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Escudo_Central_Espa%C3%B1ol_2020.png/250px-Escudo_Central_Espa%C3%B1ol_2020.png" },
  ...
  { id: "uy458", name: "M. City Torque", level: 1, color: "#0000FF", country: "UY", logo: "https://upload.wikimedia.org/wikipedia/pt/thumb/e/e2/Montevideo_City_Torque.png/250px-Montevideo_City_Torque.png" },
  { id: "uy459", name: "La Luz", level: 1, color: "#008000", country: "UY" },
  { id: "uy460", name: "Rampla Juniors", level: 1, color: "#FFFFFF", country: "UY" },
  // URUGUAI (UY) - Div 2
  { id: "uy461", name: "J. de Las Piedras", level: 1, color: "#FF0000", country: "UY", division: 2 },
  { id: "uy462", name: "U. Montevideo", level: 1, color: "#0000FF", country: "UY", division: 2 },
  ...
  { id: "uy476", name: "El T. Sisley", level: 1, color: "#FFA500", country: "UY", division: 2 },
