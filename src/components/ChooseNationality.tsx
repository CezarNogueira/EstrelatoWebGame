      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 max-w-4xl w-full">
        {NATIONALITIES.map((nat) => (
          <button
            ...
            className="p-4 rounded-2xl border-2 border-slate-700 bg-slate-800/50 hover:bg-slate-800 hover:border-emerald-500 hover:text-emerald-400 transition-all text-lg font-bold uppercase text-slate-300"
          >
            {nat}
          </button>
        ))}
